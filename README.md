...
- Installation of a JDK is required. React Native requires JDK 11 at minimum. 
- NodeJS. You will NodeJS with a minimum version of Node 14
- Android Studio. You will need an emulator to run the application. It uses gradle daemon to complie and run the application.
